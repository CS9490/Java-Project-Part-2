...
class MyArc extends MyShape{
    ...
    public MyArc(MyOval newmain, double newangle1, double newangle2, MyColor newcolor){
        ...
        Set_MyOval(newmain);
        Set_MyColor(newcolor);
        Set_P1(new MyPoint(newmain.Get_SemiMinorAxis() * Math.cos(Math.toRadians(newangle1)), newmain.Get_SemiMajorAxis() * Math.sin(Math.toRadians(newangle1))));
        Set_P2(new MyPoint(newmain.Get_SemiMinorAxis() * Math.cos(Math.toRadians(newangle2)), newmain.Get_SemiMajorAxis() * Math.sin(Math.toRadians(newangle2)))); 
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        /*//Pizza Pie problem
        MyOval oval1 = new MyOval(GC.getCanvas().getHeight()/2, GC.getCanvas().getWidth()/2, center, MyColor.BLANCHEDALMOND);
        MyArc arc1 = new MyArc(oval1, 0, 40, MyColor.BLUE); //angle 1 is the angle from which the arc is started, and angle 2 is the angle of the arc itself (so it will span from angle1 to angle1 + angle2)
        MyArc arc2 = new MyArc(oval1, 40, 80, MyColor.RED);
        MyArc arc3 = new MyArc(oval1, 80, 120, MyColor.YELLOW);
        MyArc arc4 = new MyArc(oval1, 120, 160, MyColor.ORANGE);
        MyArc arc5 = new MyArc(oval1, 160, 200, MyColor.OLIVEDRAB);
        MyArc arc6 = new MyArc(oval1, 200, 240, MyColor.PALETURQUOISE);
        MyArc arc7 = new MyArc(oval1, 240, 260, MyColor.VIOLET);
        MyArc arc8 = new MyArc(oval1, 260, 320, MyColor.DARKMAGENTA);
        MyArc arc9 = new MyArc(oval1, 360, 320, MyColor.BURLYWOOD);
        ...
        */
        ...
        //area of intersection of two MyRectangle objects
        /* 
        MyPoint tlcp1 = new MyPoint(50,50);
        MyPoint tlcp2 = new MyPoint(150, 150);
        MyRectangle r1 = new MyRectangle(200, 300, tlcp1, MyColor.BLUE);
        MyRectangle r2 = new MyRectangle(200, 300, tlcp2, MyColor.YELLOW);
        Canvas canvas1 = MyShapeInterface.drawIntersectMyShapes(r1, r2, GC, MyColor.GREEN);
        stage.setScene(scene);
        root.getChildren().add(canvas1);
        stage.show();
        */

        //area of intersection of MyCircle and MyRectangle objects
         
        MyCircle maincircle = new MyCircle(center, MyColor.SLATEGREY, 100);
        MyPoint tlcp1 = new MyPoint(50,50);
        MyRectangle r1 = new MyRectangle(200, 300, tlcp1, MyColor.BLUE);
        Canvas canvas1 = MyShapeInterface.drawIntersectMyShapes(maincircle, r1, GC, MyColor.CYAN);
        stage.setScene(scene);
        root.getChildren().add(canvas1);
        stage.show();
        ...
        /*
        MyLine test = new MyLine(new MyPoint(10,400), new MyPoint(300,100));
        MyRectangle testbounding = new MyRectangle(test.getMyBoundingRectangle());
        testbounding.Set_MyColor(MyColor.BLUE);
        
        //this tests the bounding rectangle for line

        testbounding.draw(GC);
        test.draw(GC);
        */

        /*
        MyOval oval1 = new MyOval(GC.getCanvas().getHeight()/3, GC.getCanvas().getWidth()/2, center, MyColor.BLANCHEDALMOND);
        MyArc arc1 = new MyArc(oval1, 0, 40, MyColor.GREEN);
        MyRectangle boundingarc = new MyRectangle(arc1.getMyBoundingRectangle());
        boundingarc.Set_MyColor(MyColor.BLUE);
        
        //this tests the bounding rectangle for arc
        ...
        */
        ...
        /* 
        MyCircle circle = new MyCircle(center, MyColor.AZURE, GC.getCanvas().getHeight()/6);
        MyRectangle boundingcircle = new MyRectangle(circle.getMyBoundingRectangle());
        boundingcircle.Set_MyColor(MyColor.DARKORANGE);

        //this tests for the bounding rectangle for circle

        boundingcircle.draw(GC);
        circle.draw(GC);

        /* //this is for when testing the bounding rectangles and the pizza pie part
        stage.setScene(scene);
